...
const Navbar = () => {
    ...
    const menuItems = <React.Fragment>
        <li><Link className='hover:bg-bright-red' to="/">HOME</Link></li>
        <li><Link className='hover:bg-bright-red'to="/service">SERVICE</Link></li>
        <li><Link className='hover:bg-bright-red'to="/about">ABOUT</Link></li>
        <li><Link className='hover:bg-bright-red'to="/gallery">GALLERY</Link></li>
        <li><Link className='hover:bg-bright-red'to="/blog">BLOG</Link></li>

        {user?.uid ?
            <>
                <li><Link className='uppercase' to="/dashboard">Dashboard</Link></li>
                <li><button className='btn btn-primary uppercase' onClick={handleLogOut}>Sign out</button></li>
            </>
            : <li><button className='btn btn-primary uppercase text-white'><Link to="/login">LogIn</Link></button></li>}
    </React.Fragment>
